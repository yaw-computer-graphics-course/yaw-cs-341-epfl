	...
	*/
	...
	function update_cam_transform() {
		...
		*/
		...
		const matrix_rotation_y = mat4.fromYRotation(mat4.create(), cam_angle_y);
		const matrix_rotation_z = mat4.fromZRotation(mat4.create(), cam_angle_z);

		mat4_matmul_many(mat_turntable, look_at, matrix_rotation_y, matrix_rotation_z);
	}
